...
(function () {
  ...
  const icon = (name) => {
    ...
    const map = {
      ...
      wikipedia: '<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><text x="12" y="16" text-anchor="middle" font-family="serif" font-weight="bold" font-size="16">W</text></svg>',
      ...
      facebook: '<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><text x="12" y="17" text-anchor="middle" font-family="sans-serif" font-weight="bold" font-size="18">f</text></svg>',
